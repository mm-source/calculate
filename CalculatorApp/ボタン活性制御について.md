...
namespace CalculatorApp
{
	public partial class Form1 : Form
	{
		...
		private void OnPercentButton()
		{
			...
			decimal dummyResult;
			bool isOnlyNumber = string.IsNullOrEmpty(expr) || decimal.TryParse(expr, out dummyResult);
		...
		private bool IsInputValid(string currentText, string digit)
		{
			...
			var maxDigits = startsWithZeroDot ? Constants.Numeric.MAX_FRACTION_DISPLAY_DIGITS_LEADING_ZERO : Constants.Numeric.MAX_INTEGER_DISPLAY_DIGITS;
